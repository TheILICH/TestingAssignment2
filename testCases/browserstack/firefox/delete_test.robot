...
Delete Item From Cart Test
    [Documentation]    Delete item test on Firefox via BrowserStack
    
    ${firefox_options}=    Evaluate    sys.modules['selenium.webdriver'].FirefoxOptions()    sys, selenium.webdriver
    Call Method    ${firefox_options}    set_capability    bstack:options    ${{{"buildName": "Firefox - Delete", "sessionName": "Test 4: Delete Item - Firefox"}}}
