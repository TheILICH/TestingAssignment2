...
*** Test Cases ***
Buy Product Test
    [Documentation]    Buy product test on Firefox via BrowserStack
    
    ${firefox_options}=    Evaluate    sys.modules['selenium.webdriver'].FirefoxOptions()    sys, selenium.webdriver
    Call Method    ${firefox_options}    set_capability    bstack:options    ${{{"buildName": "Firefox - Buy", "sessionName": "Test 3: Buy Product - Firefox"}}}
