...
*** Test Cases ***
Valid Logout Test
    [Documentation]    Logout test on Chrome via BrowserStack
    
    ${chrome_options}=    Evaluate    sys.modules['selenium.webdriver'].ChromeOptions()    sys, selenium.webdriver
    Call Method    ${chrome_options}    set_capability    bstack:options    ${{{"buildName": "Chrome - Logout", "sessionName": "Test 2: Logout - Chrome"}}}
